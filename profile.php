				...
				<div class="inform">
					<fieldset>
						...
						<div class="infldset">
							...
							<label>Mastodon<br /><input id="mastodon" type="text" name="form[mastodon]" value="<?php echo pun_htmlspecialchars($user['mastodon']) ?>" size="40" maxlength="75" placeholder="https://your_mastodon_url" /><br /></label>
